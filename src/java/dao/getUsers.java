...
public class getUsers {
    ...
    public getUsers(int storyid, String storyname, String storynote,String user1Task, String user1,String user2Task, String user2,String user3Task, String user3, int storybug, int swarm, String columstatus) {
